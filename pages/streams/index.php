                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card mb-4 shadow">
                                <div class="card-header">
                                    ...
                                    <i class="fas fa-book-reader"></i> All Streams</span>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <span class="text-primary font-weight-bold"> 
                                        <i class="fas fa-book-reader"></i> Add New Stream</span>
                                </div>
                                <div class="card-body">
                                    <form id="stream_form">
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <label class="text-primary" for="stream_name">Enter Stream Name</label>
                                                <input type="text" id="stream_name" name="stream_name" autocomplete="off"
                                                    class="form-control" placeholder="Raudha, Thanawii, Thanii">
                                                    <small id="emailHelp" class="form-text text-muted">Name cannot
                                                        be less than 3 digits.</small>
                                                
                                                <label class="text-primary" for="stream_code">Enter Stream Code`</label>
                                                 <input type="text" id="stream_code" name="stream_code" autocomplete="off"
                                                    class="form-control" placeholder="RAU">
