...
<!-- What is the purpose of this page.
    - The purpose of the page is to show you the subject that the teacher is teaching.
    - We can also use the page to show the details of the teacher, edit those details and 
    - also use the page to make the teacher inactive. 
 -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-info alert-dismissible fade show mb-1" role="alert">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-0">
                            <p class="mb-0">Click on change Ownership to transfer Ownership from one teacher to the
                                other.</p>
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <hr>
                        <p class="mb-0">Click on the <span><a href="" data-toggle="modal"
                                    data-target="#edit_teacher">Edit Teacher</a></span> to edit this teacher.</p>
