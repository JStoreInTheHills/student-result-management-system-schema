  ...
  columnDefs: [{
    ...
    },
    {
      ...
      data: {
        ...
        academic_year_classes_id : "academic_year_classes_id"
      },
      render: function(data){
        return `<a href="./view_academic_year_classes?academic_year_classes_id=${data.academic_year_classes_id}">${data.class_name}</a>`
      }
    },
    {
      targets: 2,
